...
<br>
<br>
      <h1 style=" font-size:50px; text-align:left;">&nbsp &nbspGir National Park</h1>
      <p><font size="5px" > &nbsp  &nbsp &nbsp &nbspJunagad, Gujarat. Established in 1965. <br>&nbsp  &nbsp &nbsp &nbspOnly abode of the Asiatic Lions.<br>&nbsp  &nbsp &nbsp &nbspFamous for – Lions, Leopards, Birding, Maldhari Community</font></p>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="item active">
        <img src="gir1.jpg"  style="width:100%;height: 50%;">
      </div>

      <div class="item">
        <img src="girn2.jpg"  style="width:100%;height: 50%;">
      </div>
    
      <div class="item">
        <img src="mainpage1.jpg"  style="width:100%;height: 50%;">
      </div>
    </div>
...
<br><br>
  ...
  <div role="main" >
    ...
    <p><h2> About Gir National Park :</h2></p>
        <font size="4px">
    ...
    <br>
    <br>
Gir National Park is located in Junagadh district of Gujarat. The forest area of Gir was the hunting grounds of the Nawabs of Junagadh. However, faced with a drastic drop in the lion population in Gir, Nawab declared Gir as a “protected” area in 1900. The 14th Asiatic Lion Census 2015 was conducted in May 2015. In 2015, the population has been 523 (27% up compared to previous census in 2010).
<br>
<br>
Devalia safari Park remains closed every Wednesday. And overall park is closed in monsoons i.e 16th June to 30th October. The peak season for safaris start from November and ends in June.
<br>
Nearest Railway station : Junagadh (55kms) Rajkot (156kms)<br>
Nearest Airport : Rajkot (156kms)<br>
    </div>
...
<%
String sql="select * from package where admin_id=3";
String url="jdbc:mysql://localhost:3306/wildlife";
String username="root";
String pass="579453";
String sql3="delete from package where sdate < now()";

String sql1="select description,sname,duration from weather,season where admin_id=3 and weather.s_id=season.s_id ";
String sql2="select * from best_places where admin_id=3";
